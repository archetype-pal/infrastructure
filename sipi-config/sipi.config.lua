...
sipi = {
    ...
    -- Set to true so that URLs like /images/filename.jpg/... resolve to
    -- imgroot/images/filename.jpg. Nginx decodes %2F to / before proxying,
    -- so "images%2Ffile.jpg" becomes "images" (prefix) + "file.jpg" (identifier).
    --
    prefix_as_path = true,
